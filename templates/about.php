...
<section class="">
    ...
    <!-- Quote -->
    <div
        class="container group cursor-pointer before:h-full before:w-full before:content-[url('../assets/img/Quote.png')] border border-slate-200 rounded-[40px] min-md:p-10 text-4xl max-md:text-lg text-zinc-400 leading-[64px] transition-all duration-500">
        <div
