                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex flex-col gap-5">
                        ...
                        <div class="flex flex-row gap-2">
                            ...
                            <a class="reply-comment cursor-pointer text-neutral-800 text-base" id="comment-reply"
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="flex flex-col gap-3">
                                        ...
                                        <div class="flex flex-row gap-2">
                                            ...
                                            <a class="cursor-pointer" href="<?php echo esc_url(get_comment_link($child_comment)); ?>">
                                                <svg class="icon">
                                                    <use href="#icon-Reply,-Share,-Circle" />
                                                </svg>
                                            </a>
