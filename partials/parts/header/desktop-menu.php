<div class="fixed inset-0 gap-20 bg-gray-50 [clip-path:polygon(0_0,_100%_0_,_100%_0_,_0_0)]  duration-700 transition-all py-7"
    id="desktopMenu">
    ...
    <div class="container flex flex-col gap-20">
        ...
        <!-- Menus -->
        <div class="grid grid-cols-3 justify-evenly py-12 border-y border-slate-200 ">
            <!-- Menu -->
