<div class="portfolio-container">
    <div class="relative container group flex flex-col md:flex-row justify-between items-start bg-no-repeat bg-cover w-full h-auto md:h-[635px] p-6 md:p-12 rounded-[80px] transition-all duration-300"
